...
output "instance_id" { value = module.vm-small.instance_id }
output "instance_public_ip" { value = module.vm-small.public_ip }
output "instance_image_id" { value = module.vm-small.effective_image_id }
output "instance_boot_volume_size_gbs" { value = module.vm-small.boot_volume_size_gbs }
